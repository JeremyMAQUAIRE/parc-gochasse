...
const AdminCartesSendSuccess = ({ show, setShow }: SendSuccessProps) => {
  return (
    <>
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium text-gray-900">Le fichier a été envoyé avec succés</p>
                  </div>
...
export default AdminCartesSendSuccess;
