...
import { actionChangeGestionParcTitle, actionClickDialogCreateParc } from '../../../store/actionCreator';
import { AppDispatch, RootState } from '../../../store/store';
import readAllGestionParcByUser from '../../../../api/directus/parc/readAllGestionParcByUser';
import createGestionParc from '../../../../api/directus/parc/createGestionParc';

const DialogCreateParc = () => {
  const dispatch: AppDispatch = useDispatch();
  const open = useSelector((state: RootState) => state.dialogReducer.dialogCreateParc);
  ...
  const handleClickCreateParc = async () => {
    await dispatch(createGestionParc());
    dispatch(actionChangeGestionParcTitle(''));
    dispatch(actionClickDialogCreateParc(false));
...
export default DialogCreateParc;
