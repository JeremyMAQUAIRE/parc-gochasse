...
import createPrestationCategory from '../../../../api/directus/prestation/createPrestationCategory';

const DialogCreatePrestation = () => {
  ...
  const handleCreatePrestation = async () => {
    await dispatch(createPrestationCategory());
    dispatch(actionClickDialogCreatePrestation(false));
...
export default DialogCreatePrestation;
