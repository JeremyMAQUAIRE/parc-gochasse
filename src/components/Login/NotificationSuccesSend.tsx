...
interface NotificationSuccesSendProps {
  show: boolean;
  setShow: (show: boolean) => void;
}

const NotificationSuccesSend = ({ show, setShow }: NotificationSuccesSendProps) => {
  return (
    <>
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium text-gray-900">Le lien de réinitialistaion a été envoyé</p>
                    <p className="mt-1 text-sm text-gray-500">Pensez à regarder dans vos spams.</p>
                  </div>
...
export default NotificationSuccesSend;
