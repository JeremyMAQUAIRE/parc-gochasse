...
import { actionClickDialogDeleteMember } from '../store/actionCreator';
...
const DialogDeleteMember = () => {
  ...
  const open = useSelector((state: RootState) => state.dialogReducer.dialogDeleteMember);
          ...
          >
            <div>
              ...
              <DialogTitle as="h3" className="text-xl font-semibold text-gray-900 bg-zinc-200 pl-6 py-4">
                Etes-vous sûr de vouloir supprimer ce membre de votre équipe?
                {/* Crois de fermeture */}
                <button
                  type="button"
            ...
            <div className="mt-5 mr-16 flex gap-4 justify-end">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  await dispatch(deleteUserSocietyMember(user.id));
