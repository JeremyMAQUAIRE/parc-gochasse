...
const ListeUserVisitorItem = ({ member }: { member: IUserMember }) => {
  ...
  return (
    <section className="w-11/12 m-auto h-14 flex items-center border-2 border-black rounded-lg mb-2 hover:scale-100 hover:bg-zinc-400">
      ...
      >
        <Eye className="mx-4 hover:text-green-600" />
      </button>
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none absolute mx-auto h-4 w-9 rounded-full bg-green-600 transition-colors duration-200 ease-in-out group-data-[checked]:bg-red-500"
        />
        <span
          aria-hidden="true"
